<rule_activation id="cfd625ab-a926-4440-866a-86827dff77a2" title="Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Driven Logging" applies_to="**/*">
...
- **R-EDL-001** SHOULD: Event-driven logging SHOULD capture state transitions and lifecycle events (start, stop, pause, resume) for operational visibility.
