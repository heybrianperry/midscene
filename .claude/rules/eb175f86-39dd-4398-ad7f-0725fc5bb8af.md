<rule_activation id="eb175f86-39dd-4398-ad7f-0725fc5bb8af" title="Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Logging Not" applies_to="**/*">
...
- **R-EDL-001** MUST_NOT: Event logging MUST NOT block the event loop or introduce synchronous I/O operations that degrade performance.
...
```bash
# Count event listeners and logging statements
...
<enforcement>
Claude Code MUST verify event-driven logging compliance through code review checklist items, static analysis detection of event emitters without logging, and integration tests validating log output for critical event flows. Violations require code review feedback before merge approval. Exceptions require performance profiling data and architecture review board evaluation.
</enforcement>