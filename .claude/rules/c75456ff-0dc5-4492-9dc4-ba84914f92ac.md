<rule_activation id="c75456ff-0dc5-4492-9dc4-ba84914f92ac" title="Standardize Backend Client Integration Pattern with Input Validation: Backend Clients Implement" applies_to="**/*">
These rules are ALWAYS ACTIVE for all backend client integrations and API integration patterns within the system.
</rule_activation>

### Rules

- **R-BCI-001** MUST: Backend clients MUST implement explicit error handling for all external service calls with appropriate error types.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of backend client input validation and error handling patterns.
</enforcement>