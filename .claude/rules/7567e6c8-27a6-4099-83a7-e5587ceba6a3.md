<rule_activation id="7567e6c8-27a6-4099-83a7-e5587ceba6a3" title="Standardize Backend Client Integration Pattern with Input Validation: Backend Clients Implement" applies_to="**/*">
These rules are ALWAYS ACTIVE for all backend client integrations and API integration patterns within the system.
</rule_activation>

### Rules

- **R-BCI-001** MAY: Backend clients MAY implement circuit breaker patterns for improved resilience
...
- Validation patterns are detected across backend client implementations with high confidence
- Error handling is consistent across all external service integrations
...
<enforcement>
Claude Code MUST NOT skip or defer verification of backend client input validation patterns. All external service integrations MUST include explicit validation before calls are made.
</enforcement>