<rule_activation id="73f54f0b-4dd2-4df1-a983-8512e80a7415" title="Standardize Middleware-Based Logging for Request/Response Lifecycle: Middleware Implement Sampling" applies_to="**/*">
...
- **R-MIDDLEWARE-001** MAY: Middleware MAY implement sampling or rate-limiting for high-volume operations to prevent log flooding while maintaining observability.
