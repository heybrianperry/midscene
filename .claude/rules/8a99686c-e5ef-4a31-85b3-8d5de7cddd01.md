<rule_activation id="8a99686c-e5ef-4a31-85b3-8d5de7cddd01" title="Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Driven Components" applies_to="**/*">
...
- **R-EDL-001** MUST: All event-driven components MUST implement logging at event boundaries (emission, reception, and completion).
...
<enforcement>
Claude Code MUST NOT skip or defer verification of event-driven logging compliance. All event-driven components MUST implement logging at event boundaries before code approval.
</enforcement>