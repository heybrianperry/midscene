<rule_activation id="e791f743-058e-461f-a478-c96d1e565f79" title="Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Message Processing Errors" applies_to="**/*">
...
- **R-MQL-001** MUST: Message processing errors MUST be logged with full error context including message payload, error type, and stack trace.
...
```bash
# Find all message queue operations and check for corresponding logging
...
<enforcement>
Clause Code MUST NOT skip or defer verification. All message queue operations require corresponding error logging with full context. Violations block merge and escalate to CI pipeline errors. Exceptions require documented justification and engineering lead approval.
</enforcement>