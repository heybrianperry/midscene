# Standardize External API Boundaries with Service Definition Patterns: External Not Expose
...
1. MUST_NOT: External APIs MUST NOT expose internal implementation types, classes, or data structures directly without abstraction

## Policy Block

- MUST_NOT External APIs MUST NOT expose internal implementation types, classes, or data structures directly without abstraction
