# Adopt Unit Testing for Integration Pattern Validation: Integration Pattern Implementations
...
1. MUST: All integration pattern implementations MUST include unit tests that validate the integration contract and behavior

## Policy Block

- MUST All integration pattern implementations MUST include unit tests that validate the integration contract and behavior
