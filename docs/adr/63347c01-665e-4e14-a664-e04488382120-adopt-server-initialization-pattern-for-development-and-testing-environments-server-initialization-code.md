# Adopt Server Initialization Pattern for Development and Testing Environments: Server Initialization Code
...
1. MUST: Server initialization code MUST be extracted into reusable modules that can be invoked programmatically from tests, CLI tools, and playground applications

## Policy Block

- MUST Server initialization code MUST be extracted into reusable modules that can be invoked programmatically from tests, CLI tools, and playground applications
