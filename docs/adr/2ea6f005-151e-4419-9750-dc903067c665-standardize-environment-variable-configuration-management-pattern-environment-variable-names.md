# Standardize Environment Variable Configuration Management Pattern: Environment Variable Names
...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention (e.g., UPPER_SNAKE_CASE with package prefix)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention (e.g., UPPER_SNAKE_CASE with package prefix)
