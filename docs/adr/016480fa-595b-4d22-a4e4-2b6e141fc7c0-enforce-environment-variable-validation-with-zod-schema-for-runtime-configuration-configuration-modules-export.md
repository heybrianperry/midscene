# Enforce Environment Variable Validation with Zod Schema for Runtime Configuration: Configuration Modules Export
...
1. MAY: Configuration modules MAY export both the Zod schema and the validated configuration object for reuse and testing

## Policy Block

- MAY Configuration modules MAY export both the Zod schema and the validated configuration object for reuse and testing
