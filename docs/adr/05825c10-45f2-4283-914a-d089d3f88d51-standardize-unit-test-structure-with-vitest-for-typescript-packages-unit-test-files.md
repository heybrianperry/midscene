# Standardize Unit Test Structure with Vitest for TypeScript Packages: Unit Test Files
...
1. MUST: Unit test files MUST be named with the .test.ts extension

## Policy Block

- MUST Unit test files MUST be named with the .test.ts extension
