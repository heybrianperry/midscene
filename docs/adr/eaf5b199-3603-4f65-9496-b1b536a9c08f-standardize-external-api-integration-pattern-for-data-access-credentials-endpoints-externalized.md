# Standardize External API Integration Pattern for Data Access: Credentials Endpoints Externalized
...
1. SHOULD: API credentials and endpoints SHOULD be externalized to configuration files or environment variables, never hardcoded

## Policy Block

- SHOULD API credentials and endpoints SHOULD be externalized to configuration files or environment variables, never hardcoded
