# Adopt Environment-Driven Configuration Management for Chrome Extension Packaging and Device Control: Production Credentials Keys
...
1. MUST_NOT: Production credentials, API keys, or sensitive configuration MUST NOT be committed to source control or embedded in build artifacts

## Policy Block

- MUST_NOT Production credentials, API keys, or sensitive configuration MUST NOT be committed to source control or embedded in build artifacts
