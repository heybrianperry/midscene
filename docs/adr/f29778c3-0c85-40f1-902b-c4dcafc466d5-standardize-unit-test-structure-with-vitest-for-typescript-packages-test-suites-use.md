# Standardize Unit Test Structure with Vitest for TypeScript Packages: Test Suites Use
...
1. SHOULD: Test suites SHOULD use describe blocks to group related tests and it/test blocks for individual test cases

## Policy Block

- SHOULD Test suites SHOULD use describe blocks to group related tests and it/test blocks for individual test cases
