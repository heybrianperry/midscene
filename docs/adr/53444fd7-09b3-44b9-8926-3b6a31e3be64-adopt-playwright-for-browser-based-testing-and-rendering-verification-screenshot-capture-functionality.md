# Adopt Playwright for Browser-Based Testing and Rendering Verification: Screenshot Capture Functionality
...
1. MUST: Screenshot capture functionality MUST implement CDP fallback mechanisms to ensure reliability across different browser contexts

## Policy Block

- MUST Screenshot capture functionality MUST implement CDP fallback mechanisms to ensure reliability across different browser contexts
