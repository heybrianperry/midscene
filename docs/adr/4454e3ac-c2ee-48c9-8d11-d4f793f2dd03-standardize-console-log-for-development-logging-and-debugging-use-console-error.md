# Standardize console.log for Development Logging and Debugging: Use Console Error
...
1. SHOULD: Use console.error for error conditions and console.warn for warning conditions to distinguish severity levels

## Policy Block

- SHOULD Use console.error for error conditions and console.warn for warning conditions to distinguish severity levels
