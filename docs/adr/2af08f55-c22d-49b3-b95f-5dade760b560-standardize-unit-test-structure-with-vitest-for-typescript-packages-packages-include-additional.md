# Standardize Unit Test Structure with Vitest for TypeScript Packages: Packages Include Additional
...
1. MAY: Packages MAY include additional test types (integration, e2e) in separate directories with appropriate naming conventions

## Policy Block

- MAY Packages MAY include additional test types (integration, e2e) in separate directories with appropriate naming conventions
