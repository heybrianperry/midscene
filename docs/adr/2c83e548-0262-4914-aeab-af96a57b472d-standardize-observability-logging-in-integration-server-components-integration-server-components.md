# Standardize Observability Logging in Integration Server Components: Integration Server Components
...
1. MUST: All integration server components (HTTP servers, WebSocket servers, IPC bridges) MUST implement structured logging using a standardized logging framework

## Policy Block

- MUST All integration server components (HTTP servers, WebSocket servers, IPC bridges) MUST implement structured logging using a standardized logging framework
