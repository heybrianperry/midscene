# Adopt Unit Testing for Integration Pattern Validation: Test File Naming
...
1. SHOULD: Test file naming SHOULD follow the convention of <component-name>.test.<ext> to clearly identify test files

## Policy Block

- SHOULD Test file naming SHOULD follow the convention of <component-name>.test.<ext> to clearly identify test files
