# Adopt Event-Driven Async Integration Pattern for Backend Communication: Integration Code Not
...
1. MUST_NOT: Integration code MUST NOT use synchronous blocking calls for network I/O, file operations, or inter-process communication

## Policy Block

- MUST_NOT Integration code MUST NOT use synchronous blocking calls for network I/O, file operations, or inter-process communication
