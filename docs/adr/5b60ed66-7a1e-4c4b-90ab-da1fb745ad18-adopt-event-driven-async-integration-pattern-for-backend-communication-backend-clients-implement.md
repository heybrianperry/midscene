# Adopt Event-Driven Async Integration Pattern for Backend Communication: Backend Clients Implement
...
1. SHOULD: Backend clients SHOULD implement connection pooling and reuse patterns to optimize resource utilization

## Policy Block

- SHOULD Backend clients SHOULD implement connection pooling and reuse patterns to optimize resource utilization
