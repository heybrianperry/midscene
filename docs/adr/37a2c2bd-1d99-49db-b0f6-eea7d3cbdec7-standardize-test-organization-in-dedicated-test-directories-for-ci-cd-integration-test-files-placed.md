# Standardize Test Organization in Dedicated Test Directories for CI/CD Integration: Test Files Placed
...
1. MUST: Test files MUST be placed in dedicated test directories (tests/, tests/unit/, tests/integration/) rather than co-located with source files

## Policy Block

- MUST Test files MUST be placed in dedicated test directories (tests/, tests/unit/, tests/integration/) rather than co-located with source files
