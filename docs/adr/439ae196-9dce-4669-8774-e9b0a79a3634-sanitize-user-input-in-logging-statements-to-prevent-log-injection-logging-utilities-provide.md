# Sanitize User Input in Logging Statements to Prevent Log Injection: Logging Utilities Provide
...
1. SHOULD: Logging utilities SHOULD provide centralized sanitization functions to ensure consistent application of input validation rules

## Policy Block

- SHOULD Logging utilities SHOULD provide centralized sanitization functions to ensure consistent application of input validation rules
