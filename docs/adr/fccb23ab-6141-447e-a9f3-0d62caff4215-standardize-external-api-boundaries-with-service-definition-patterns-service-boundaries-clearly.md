# Standardize External API Boundaries with Service Definition Patterns: Service Boundaries Clearly
...
1. MUST: Service boundaries MUST clearly separate public API surfaces from internal implementation details

## Policy Block

- MUST Service boundaries MUST clearly separate public API surfaces from internal implementation details
