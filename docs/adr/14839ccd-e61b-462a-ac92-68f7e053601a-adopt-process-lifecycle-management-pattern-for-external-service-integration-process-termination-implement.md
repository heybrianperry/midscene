# Adopt Process Lifecycle Management Pattern for External Service Integration: Process Termination Implement
...
1. MUST: Process termination MUST implement graceful shutdown with fallback to forced termination after timeout

## Policy Block

- MUST Process termination MUST implement graceful shutdown with fallback to forced termination after timeout
