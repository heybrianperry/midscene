# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Websocket Clients Implement
...
1. SHOULD: WebSocket clients SHOULD implement connection state management with distinct states for connecting, connected, disconnecting, and disconnected

## Policy Block

- SHOULD WebSocket clients SHOULD implement connection state management with distinct states for connecting, connected, disconnecting, and disconnected
