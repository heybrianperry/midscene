# Adopt Event-Driven Polling with Interval-Based State Synchronization: Keepalive Mechanisms Use
...
1. SHOULD: Keepalive mechanisms SHOULD use configurable intervals to allow tuning based on network conditions and application requirements

## Policy Block

- SHOULD Keepalive mechanisms SHOULD use configurable intervals to allow tuning based on network conditions and application requirements
