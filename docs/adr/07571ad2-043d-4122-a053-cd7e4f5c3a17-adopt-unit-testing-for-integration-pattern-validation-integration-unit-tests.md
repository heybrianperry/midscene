...
1. MUST: Integration unit tests MUST execute independently without requiring running external services or infrastructure

## Policy Block

- MUST Integration unit tests MUST execute independently without requiring running external services or infrastructure
