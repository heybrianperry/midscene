# Adopt Client-Side Cache Layer for Public API State Management: Responses Include Cache
...
1. SHOULD: API responses SHOULD include cache control headers (Cache-Control, ETag, Last-Modified) to guide client-side caching behavior

## Policy Block

- SHOULD API responses SHOULD include cache control headers (Cache-Control, ETag, Last-Modified) to guide client-side caching behavior
