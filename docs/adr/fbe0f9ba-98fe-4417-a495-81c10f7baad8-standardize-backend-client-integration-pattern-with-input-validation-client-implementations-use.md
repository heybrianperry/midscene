# Standardize Backend Client Integration Pattern with Input Validation: Client Implementations Use
...
1. SHOULD: Client implementations SHOULD use TypeScript interfaces to define clear contracts for request and response types

## Policy Block

- SHOULD Client implementations SHOULD use TypeScript interfaces to define clear contracts for request and response types
