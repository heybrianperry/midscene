# Adopt Vitest as Standard Test Framework for CI/CD Pipeline: Test Files Use
...
1. MUST: All test files MUST use Vitest as the test framework and follow the .test.ts naming convention

## Policy Block

- MUST All test files MUST use Vitest as the test framework and follow the .test.ts naming convention
