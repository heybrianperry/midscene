# Enforce Environment Variable Validation with Zod Schema for Runtime Configuration: Validation Failures Result
...
1. MUST: Validation failures MUST result in clear, actionable error messages indicating which configuration values are invalid and why

## Policy Block

- MUST Validation failures MUST result in clear, actionable error messages indicating which configuration values are invalid and why
