# Adopt Playwright for Browser-Based Testing and Rendering Verification: Component Tests Cover
...
1. SHOULD: UI component tests SHOULD cover edge cases such as narrow input prompts and constrained viewport scenarios

## Policy Block

- SHOULD UI component tests SHOULD cover edge cases such as narrow input prompts and constrained viewport scenarios
