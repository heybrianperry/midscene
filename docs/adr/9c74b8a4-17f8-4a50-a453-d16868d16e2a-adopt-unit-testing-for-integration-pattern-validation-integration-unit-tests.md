# Adopt Unit Testing for Integration Pattern Validation: Integration Unit Tests
...
1. SHOULD: Integration unit tests SHOULD be organized in dedicated test directories following the pattern tests/unit-test/ or tests/

## Policy Block

- SHOULD Integration unit tests SHOULD be organized in dedicated test directories following the pattern tests/unit-test/ or tests/
