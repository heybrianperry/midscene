# Standardize Environment Variable Configuration for Runtime Secrets Management: Environment Variable Values
...
1. MUST_NOT: Environment variable values containing secrets MUST NOT be logged, printed to console, or included in error messages in production environments

## Policy Block

- MUST_NOT Environment variable values containing secrets MUST NOT be logged, printed to console, or included in error messages in production environments
