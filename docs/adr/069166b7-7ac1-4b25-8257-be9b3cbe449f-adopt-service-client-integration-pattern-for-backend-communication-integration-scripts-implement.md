# Adopt Service Client Integration Pattern for Backend Communication: Integration Scripts Implement
...
1. SHOULD: Integration scripts SHOULD implement wait mechanisms and health checks to ensure backend service availability

## Policy Block

- SHOULD Integration scripts SHOULD implement wait mechanisms and health checks to ensure backend service availability
