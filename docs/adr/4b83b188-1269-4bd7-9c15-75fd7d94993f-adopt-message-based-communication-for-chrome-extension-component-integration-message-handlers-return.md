# Adopt Message-Based Communication for Chrome Extension Component Integration: Message Handlers Return
...
1. SHOULD: Message handlers SHOULD return promises or use the sendResponse callback for bidirectional communication

## Policy Block

- SHOULD Message handlers SHOULD return promises or use the sendResponse callback for bidirectional communication
