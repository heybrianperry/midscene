# Adopt IndexedDB as Client-Side Cache Layer for Logging and State Persistence: Applications Implement Synchronization
...
1. MAY: Applications MAY implement synchronization mechanisms to periodically upload cached logs to remote servers when connectivity is available

## Policy Block

- MAY Applications MAY implement synchronization mechanisms to periodically upload cached logs to remote servers when connectivity is available
