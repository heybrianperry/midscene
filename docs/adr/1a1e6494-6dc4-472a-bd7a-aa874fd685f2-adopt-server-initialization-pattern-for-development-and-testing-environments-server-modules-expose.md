# Adopt Server Initialization Pattern for Development and Testing Environments: Server Modules Expose
...
1. MAY: Server modules MAY expose both programmatic APIs and CLI entry points from the same codebase

## Policy Block

- MAY Server modules MAY expose both programmatic APIs and CLI entry points from the same codebase
