# Adopt Event-Driven Process Lifecycle Management for External Services: Process Managers Implement
...
1. SHOULD: Process managers SHOULD implement timeout mechanisms for startup and shutdown operations to prevent indefinite hangs

## Policy Block

- SHOULD Process managers SHOULD implement timeout mechanisms for startup and shutdown operations to prevent indefinite hangs
