# Adopt Backend Client Integration Pattern for External Service Communication: Backend Client Implementations
...
1. MUST: All backend client implementations MUST encapsulate connection logic in dedicated client classes or modules that abstract the underlying communication protocol

## Policy Block

- MUST All backend client implementations MUST encapsulate connection logic in dedicated client classes or modules that abstract the underlying communication protocol
