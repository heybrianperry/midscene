# Adopt Event-Driven Data Access with Buffering and Retry Mechanisms: Event Optimizers Data
...
1. MUST: Event optimizers and data access layers MUST provide observable metrics for monitoring buffer depths, retry attempts, and failure rates

## Policy Block

- MUST Event optimizers and data access layers MUST provide observable metrics for monitoring buffer depths, retry attempts, and failure rates
