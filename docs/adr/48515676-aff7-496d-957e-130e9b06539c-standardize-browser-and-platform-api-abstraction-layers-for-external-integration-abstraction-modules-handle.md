# Standardize Browser and Platform API Abstraction Layers for External Integration: Abstraction Modules Handle
...
1. MUST: Abstraction modules MUST handle platform availability checks and provide graceful degradation or clear error messages when APIs are unavailable

## Policy Block

- MUST Abstraction modules MUST handle platform availability checks and provide graceful degradation or clear error messages when APIs are unavailable
