...
1. MUST_NOT: Data access operations MUST NOT block the main event loop or create synchronous bottlenecks in event handlers

## Policy Block

- MUST_NOT Data access operations MUST NOT block the main event loop or create synchronous bottlenecks in event handlers
