# Adopt Event-Driven Polling with Interval-Based State Synchronization: Periodic Data Access
...
1. MUST: All periodic data access patterns MUST use interval-based timers (setInterval, setTimeout) rather than recursive polling or busy-waiting loops

## Policy Block

- MUST All periodic data access patterns MUST use interval-based timers (setInterval, setTimeout) rather than recursive polling or busy-waiting loops
