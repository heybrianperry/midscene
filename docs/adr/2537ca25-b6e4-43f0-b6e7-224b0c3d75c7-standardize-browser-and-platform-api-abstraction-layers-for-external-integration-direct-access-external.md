# Standardize Browser and Platform API Abstraction Layers for External Integration: Direct Access External
...
1. MUST: All direct access to external platform APIs (Chrome Extension APIs, browser globals, native system APIs) MUST be encapsulated through dedicated abstraction modules or utility wrappers

## Policy Block

- MUST All direct access to external platform APIs (Chrome Extension APIs, browser globals, native system APIs) MUST be encapsulated through dedicated abstraction modules or utility wrappers
