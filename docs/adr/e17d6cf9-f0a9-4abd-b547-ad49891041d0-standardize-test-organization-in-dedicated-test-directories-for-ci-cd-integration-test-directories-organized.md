# Standardize Test Organization in Dedicated Test Directories for CI/CD Integration: Test Directories Organized
...
1. SHOULD: Test directories SHOULD be organized by test type (unit, integration, e2e) to support selective test execution in CI/CD pipelines

## Policy Block

- SHOULD Test directories SHOULD be organized by test type (unit, integration, e2e) to support selective test execution in CI/CD pipelines
