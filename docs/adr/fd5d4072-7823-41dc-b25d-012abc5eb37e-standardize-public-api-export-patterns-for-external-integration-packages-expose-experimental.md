# Standardize Public API Export Patterns for External Integration: Packages Expose Experimental
...
1. MAY: Packages MAY expose experimental APIs marked with clear stability warnings for early adopter feedback

## Policy Block

- MAY Packages MAY expose experimental APIs marked with clear stability warnings for early adopter feedback
