# Adopt Service Client Integration Pattern for Backend Communication: Backend Client Implementations
...
1. MUST: Backend client implementations MUST be encapsulated in dedicated client modules with clear service boundaries

## Policy Block

- MUST Backend client implementations MUST be encapsulated in dedicated client modules with clear service boundaries
