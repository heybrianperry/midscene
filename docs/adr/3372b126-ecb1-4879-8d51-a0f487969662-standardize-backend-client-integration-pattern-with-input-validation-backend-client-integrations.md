# Standardize Backend Client Integration Pattern with Input Validation: Backend Client Integrations
...
1. MUST: All backend client integrations MUST validate input parameters before sending requests to external services

## Policy Block

- MUST All backend client integrations MUST validate input parameters before sending requests to external services
