# Adopt Unit Testing for Integration Pattern Validation: Backend Client Integrations
...
1. SHOULD: Backend client integrations SHOULD include smoke tests that validate basic startup and initialization behavior

## Policy Block

- SHOULD Backend client integrations SHOULD include smoke tests that validate basic startup and initialization behavior
