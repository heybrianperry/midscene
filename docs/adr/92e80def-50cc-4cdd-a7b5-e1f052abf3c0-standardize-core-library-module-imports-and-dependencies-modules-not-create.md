# Standardize Core Library Module Imports and Dependencies: Modules Not Create
...
1. MUST_NOT: Modules MUST NOT create circular dependencies between core libraries and application code

## Policy Block

- MUST_NOT Modules MUST NOT create circular dependencies between core libraries and application code
