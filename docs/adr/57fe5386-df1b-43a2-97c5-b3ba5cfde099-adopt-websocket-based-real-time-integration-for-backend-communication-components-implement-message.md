# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Components Implement Message
...
1. MAY: Components MAY implement message queuing for outbound messages during connection interruptions to ensure message delivery after reconnection

## Policy Block

- MAY Components MAY implement message queuing for outbound messages during connection interruptions to ensure message delivery after reconnection
