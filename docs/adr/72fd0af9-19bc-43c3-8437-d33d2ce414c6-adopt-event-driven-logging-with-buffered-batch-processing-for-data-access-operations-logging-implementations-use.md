# Adopt Event-Driven Logging with Buffered Batch Processing for Data Access Operations: Logging Implementations Use
...
1. MUST: Logging implementations MUST use buffered batch processing to avoid blocking data access operations

## Policy Block

- MUST Logging implementations MUST use buffered batch processing to avoid blocking data access operations
