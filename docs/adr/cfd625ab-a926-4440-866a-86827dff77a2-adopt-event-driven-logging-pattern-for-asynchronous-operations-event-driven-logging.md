# Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Driven Logging
...
1. SHOULD: Event-driven logging SHOULD capture state transitions and lifecycle events (start, stop, pause, resume) for operational visibility

## Policy Block

- SHOULD Event-driven logging SHOULD capture state transitions and lifecycle events (start, stop, pause, resume) for operational visibility
