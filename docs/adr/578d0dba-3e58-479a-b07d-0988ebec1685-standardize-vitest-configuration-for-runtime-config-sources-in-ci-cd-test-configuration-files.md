# Standardize Vitest Configuration for Runtime Config Sources in CI/CD: Test Configuration Files
...
1. MUST: Test configuration files MUST be named 'vitest.config.ts' and placed at the package root level

## Policy Block

- MUST Test configuration files MUST be named 'vitest.config.ts' and placed at the package root level
