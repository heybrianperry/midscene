# Adopt Event-Driven Process Lifecycle Management for External Services: Integration Boundaries Expose
...
1. MUST: Integration boundaries MUST expose promise-based or event-based APIs for asynchronous process lifecycle operations

## Policy Block

- MUST Integration boundaries MUST expose promise-based or event-based APIs for asynchronous process lifecycle operations
