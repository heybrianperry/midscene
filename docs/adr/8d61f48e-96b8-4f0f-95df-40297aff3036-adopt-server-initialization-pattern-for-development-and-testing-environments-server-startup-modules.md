# Adopt Server Initialization Pattern for Development and Testing Environments: Server Startup Modules
...
1. SHOULD: Server startup modules SHOULD implement graceful shutdown handlers for SIGTERM and SIGINT signals

## Policy Block

- SHOULD Server startup modules SHOULD implement graceful shutdown handlers for SIGTERM and SIGINT signals
