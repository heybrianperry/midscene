# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Websocket Error Events
...
1. MUST: WebSocket error events MUST be logged with sufficient context for debugging and MUST trigger appropriate error recovery procedures

## Policy Block

- MUST WebSocket error events MUST be logged with sufficient context for debugging and MUST trigger appropriate error recovery procedures
