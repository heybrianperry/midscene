# Adopt Event-Driven Logging with Buffered Batch Processing for Data Access Operations: Event Optimizers Deduplicate
...
1. SHOULD: Event optimizers SHOULD deduplicate or aggregate similar events within a time window to reduce log volume

## Policy Block

- SHOULD Event optimizers SHOULD deduplicate or aggregate similar events within a time window to reduce log volume
