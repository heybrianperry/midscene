# Adopt Event-Driven Logging Pattern for Asynchronous Operations: Components Implement Structured
...
1. MAY: Components MAY implement structured logging formats (JSON, key-value pairs) to facilitate automated log analysis and aggregation

## Policy Block

- MAY Components MAY implement structured logging formats (JSON, key-value pairs) to facilitate automated log analysis and aggregation
