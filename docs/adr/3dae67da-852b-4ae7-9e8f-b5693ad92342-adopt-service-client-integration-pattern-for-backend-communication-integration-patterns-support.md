# Adopt Service Client Integration Pattern for Backend Communication: Integration Patterns Support
...
1. MUST: Integration patterns MUST support multiple execution contexts including browser environments, Node.js scripts, and Electron processes

## Policy Block

- MUST Integration patterns MUST support multiple execution contexts including browser environments, Node.js scripts, and Electron processes
