# Standardize External API Boundaries with Service Definition Patterns: Public Definitions Located
...
1. SHOULD: Public API definitions SHOULD be co-located with their primary consumers or in dedicated API definition modules

## Policy Block

- SHOULD Public API definitions SHOULD be co-located with their primary consumers or in dedicated API definition modules
