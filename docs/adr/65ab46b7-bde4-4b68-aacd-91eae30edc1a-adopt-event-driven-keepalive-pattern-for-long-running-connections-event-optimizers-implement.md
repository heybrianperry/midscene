# Adopt Event-Driven Keepalive Pattern for Long-Running Connections: Event Optimizers Implement
...
1. SHOULD: Event optimizers SHOULD implement debouncing or throttling strategies to reduce event processing overhead

## Policy Block

- SHOULD Event optimizers SHOULD implement debouncing or throttling strategies to reduce event processing overhead
