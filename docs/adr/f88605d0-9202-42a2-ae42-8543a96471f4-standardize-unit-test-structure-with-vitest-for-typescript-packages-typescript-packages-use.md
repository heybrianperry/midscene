# Standardize Unit Test Structure with Vitest for TypeScript Packages: Typescript Packages Use
...
1. MUST: All TypeScript packages MUST use Vitest as the unit testing framework

## Policy Block

- MUST All TypeScript packages MUST use Vitest as the unit testing framework
