# Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Driven Components
...
1. MUST: All event-driven components MUST implement logging at event boundaries (emission, reception, and completion)

## Policy Block

- MUST All event-driven components MUST implement logging at event boundaries (emission, reception, and completion)
