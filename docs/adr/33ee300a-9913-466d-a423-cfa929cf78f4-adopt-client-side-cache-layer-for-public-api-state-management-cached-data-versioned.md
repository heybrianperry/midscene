# Adopt Client-Side Cache Layer for Public API State Management: Cached Data Versioned
...
1. MUST: Cached data MUST be versioned to handle schema changes and prevent stale data corruption

## Policy Block

- MUST Cached data MUST be versioned to handle schema changes and prevent stale data corruption
