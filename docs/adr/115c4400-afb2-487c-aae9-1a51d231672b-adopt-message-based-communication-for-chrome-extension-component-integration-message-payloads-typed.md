# Adopt Message-Based Communication for Chrome Extension Component Integration: Message Payloads Typed
...
1. SHOULD: Message payloads SHOULD be typed using TypeScript interfaces to ensure type safety across context boundaries

## Policy Block

- SHOULD Message payloads SHOULD be typed using TypeScript interfaces to ensure type safety across context boundaries
