# Adopt Event-Driven Data Access with Buffering and Retry Mechanisms: Event Driven Data
...
1. SHOULD: Event-driven data access patterns SHOULD use queue-based architectures to decouple producers from consumers and enable asynchronous processing

## Policy Block

- SHOULD Event-driven data access patterns SHOULD use queue-based architectures to decouple producers from consumers and enable asynchronous processing
