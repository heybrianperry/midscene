# Standardize Unit Test Structure with Vitest for TypeScript Packages: Unit Tests Organized
...
1. MUST: Unit tests MUST be organized in a tests/unit or tests/unit-test directory within each package

## Policy Block

- MUST Unit tests MUST be organized in a tests/unit or tests/unit-test directory within each package
