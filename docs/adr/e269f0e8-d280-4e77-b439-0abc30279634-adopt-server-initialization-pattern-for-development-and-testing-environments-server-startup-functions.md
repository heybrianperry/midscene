# Adopt Server Initialization Pattern for Development and Testing Environments: Server Startup Functions
...
1. MUST: Server startup functions MUST accept configuration parameters (port, host, environment settings) rather than hardcoding values

## Policy Block

- MUST Server startup functions MUST accept configuration parameters (port, host, environment settings) rather than hardcoding values
