# Standardize Browser and Platform API Abstraction Layers for External Integration: Platform Wrappers Provide
...
1. MAY: Platform API wrappers MAY provide additional convenience methods or enhanced error handling beyond the base platform API capabilities

## Policy Block

- MAY Platform API wrappers MAY provide additional convenience methods or enhanced error handling beyond the base platform API capabilities
