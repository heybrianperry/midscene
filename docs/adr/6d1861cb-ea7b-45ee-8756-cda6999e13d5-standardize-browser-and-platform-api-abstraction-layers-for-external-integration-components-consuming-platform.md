# Standardize Browser and Platform API Abstraction Layers for External Integration: Components Consuming Platform
...
1. SHOULD: Components consuming platform APIs SHOULD depend on abstraction interfaces rather than concrete implementations to enable testing with mocks or stubs

## Policy Block

- SHOULD Components consuming platform APIs SHOULD depend on abstraction interfaces rather than concrete implementations to enable testing with mocks or stubs
