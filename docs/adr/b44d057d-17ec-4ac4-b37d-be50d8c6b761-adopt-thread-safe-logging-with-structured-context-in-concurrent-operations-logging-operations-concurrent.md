# Adopt Thread-Safe Logging with Structured Context in Concurrent Operations: Logging Operations Concurrent
...
1. MUST: All logging operations in concurrent contexts (web workers, async handlers, event bridges) MUST use thread-safe logging mechanisms that prevent race conditions and data corruption

## Policy Block

- MUST All logging operations in concurrent contexts (web workers, async handlers, event bridges) MUST use thread-safe logging mechanisms that prevent race conditions and data corruption
