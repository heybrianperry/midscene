# Standardize console.log for Development Logging and Debugging: Structure Log Messages
...
1. SHOULD: Structure log messages with consistent prefixes or identifiers to enable filtering and searching in console output

## Policy Block

- SHOULD Structure log messages with consistent prefixes or identifiers to enable filtering and searching in console output
