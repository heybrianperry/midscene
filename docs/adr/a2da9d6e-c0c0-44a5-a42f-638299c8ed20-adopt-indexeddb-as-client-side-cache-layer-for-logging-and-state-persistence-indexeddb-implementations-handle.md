# Adopt IndexedDB as Client-Side Cache Layer for Logging and State Persistence: Indexeddb Implementations Handle
...
1. MUST: IndexedDB implementations MUST handle asynchronous operations using Promises or async/await patterns to prevent blocking the main thread

## Policy Block

- MUST IndexedDB implementations MUST handle asynchronous operations using Promises or async/await patterns to prevent blocking the main thread
