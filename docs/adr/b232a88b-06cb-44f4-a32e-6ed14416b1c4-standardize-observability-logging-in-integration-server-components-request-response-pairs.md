# Standardize Observability Logging in Integration Server Components: Request Response Pairs
...
1. MUST: Request/response pairs MUST be logged with correlation IDs to enable tracing across system boundaries

## Policy Block

- MUST Request/response pairs MUST be logged with correlation IDs to enable tracing across system boundaries
