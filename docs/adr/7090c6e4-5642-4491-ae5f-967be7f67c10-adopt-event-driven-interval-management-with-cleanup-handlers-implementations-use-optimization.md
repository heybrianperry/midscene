# Adopt Event-Driven Interval Management with Cleanup Handlers: Implementations Use Optimization
...
1. MAY: Implementations MAY use optimization techniques such as debouncing or throttling to reduce unnecessary data access operations

## Policy Block

- MAY Implementations MAY use optimization techniques such as debouncing or throttling to reduce unnecessary data access operations
