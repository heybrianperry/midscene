# Adopt Process Lifecycle Management Pattern for External Service Integration: External Service Integrations
...
1. SHOULD: External service integrations SHOULD implement cleanup handlers to ensure resources are released on unexpected termination

## Policy Block

- SHOULD External service integrations SHOULD implement cleanup handlers to ensure resources are released on unexpected termination
