# Adopt React Component Export Pattern with Named Index Exports: Component Implementation Files
...
1. MUST: Component implementation files MUST be separate from the index.tsx export file to maintain clear separation between implementation and public API

## Policy Block

- MUST Component implementation files MUST be separate from the index.tsx export file to maintain clear separation between implementation and public API
