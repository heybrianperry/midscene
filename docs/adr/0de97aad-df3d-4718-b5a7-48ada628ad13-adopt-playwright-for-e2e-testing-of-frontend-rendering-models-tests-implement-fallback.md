# Adopt Playwright for E2E Testing of Frontend Rendering Models: Tests Implement Fallback
...
1. MUST: Tests MUST implement fallback mechanisms (e.g., CDP fallback for screenshots) to handle browser API limitations

## Policy Block

- MUST Tests MUST implement fallback mechanisms (e.g., CDP fallback for screenshots) to handle browser API limitations
