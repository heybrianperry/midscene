# Adopt Backend Client Integration Pattern for External Service Communication: Client Implementations Implement
...
1. MAY: Client implementations MAY implement connection pooling or reuse strategies when appropriate for the underlying protocol

## Policy Block

- MAY Client implementations MAY implement connection pooling or reuse strategies when appropriate for the underlying protocol
