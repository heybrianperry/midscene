# Adopt Playwright for E2E Testing of Frontend Rendering Models: E2e Tests Cover
...
1. MUST: E2E tests MUST cover critical rendering paths including navigation (goto), cache functionality, input rendering, and screenshot capabilities

## Policy Block

- MUST E2E tests MUST cover critical rendering paths including navigation (goto), cache functionality, input rendering, and screenshot capabilities
