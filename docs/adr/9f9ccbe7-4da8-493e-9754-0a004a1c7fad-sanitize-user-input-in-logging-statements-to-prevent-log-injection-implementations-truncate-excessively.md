# Sanitize User Input in Logging Statements to Prevent Log Injection: Implementations Truncate Excessively
...
1. MAY: Implementations MAY truncate excessively long input values to prevent log flooding attacks

## Policy Block

- MAY Implementations MAY truncate excessively long input values to prevent log flooding attacks
