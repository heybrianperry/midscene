# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Websocket Connections Implement
...
1. MUST: WebSocket connections MUST implement automatic reconnection logic with exponential backoff to handle transient network failures

## Policy Block

- MUST WebSocket connections MUST implement automatic reconnection logic with exponential backoff to handle transient network failures
