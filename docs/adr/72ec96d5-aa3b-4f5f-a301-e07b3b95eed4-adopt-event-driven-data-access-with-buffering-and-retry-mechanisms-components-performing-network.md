# Adopt Event-Driven Data Access with Buffering and Retry Mechanisms: Components Performing Network
...
1. MUST: Components performing network-based data access MUST implement retry logic with exponential backoff for transient failures

## Policy Block

- MUST Components performing network-based data access MUST implement retry logic with exponential backoff for transient failures
