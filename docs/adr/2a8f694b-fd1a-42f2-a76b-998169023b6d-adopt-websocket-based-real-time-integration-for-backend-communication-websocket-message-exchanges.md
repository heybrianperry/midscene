# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Websocket Message Exchanges
...
1. MUST: All WebSocket message exchanges MUST use structured message formats (JSON or binary protocols) with explicit message type identifiers for routing and handling

## Policy Block

- MUST All WebSocket message exchanges MUST use structured message formats (JSON or binary protocols) with explicit message type identifiers for routing and handling
