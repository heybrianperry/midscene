# Adopt Process Lifecycle Management Pattern for External Service Integration: Integration Modules Expose
...
1. SHOULD: Integration modules SHOULD expose consistent APIs for start, stop, and status operations across different service types

## Policy Block

- SHOULD Integration modules SHOULD expose consistent APIs for start, stop, and status operations across different service types
