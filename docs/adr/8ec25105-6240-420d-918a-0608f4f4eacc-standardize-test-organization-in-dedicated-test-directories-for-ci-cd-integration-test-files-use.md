# Standardize Test Organization in Dedicated Test Directories for CI/CD Integration: Test Files Use
...
1. MUST: Test files MUST use the .test.ts extension for TypeScript test files to enable automated test discovery

## Policy Block

- MUST Test files MUST use the .test.ts extension for TypeScript test files to enable automated test discovery
