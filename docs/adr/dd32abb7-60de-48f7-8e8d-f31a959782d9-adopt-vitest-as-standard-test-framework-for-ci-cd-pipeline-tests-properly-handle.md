# Adopt Vitest as Standard Test Framework for CI/CD Pipeline: Tests Properly Handle
...
1. MUST: Tests MUST properly handle asynchronous operations using async/await patterns supported by Vitest

## Policy Block

- MUST Tests MUST properly handle asynchronous operations using async/await patterns supported by Vitest
