# Standardize Environment Variable Configuration for Runtime Secrets Management: Components Provide Default
...
1. SHOULD: Components SHOULD provide default values for non-sensitive configuration while requiring explicit values for secrets

## Policy Block

- SHOULD Components SHOULD provide default values for non-sensitive configuration while requiring explicit values for secrets
