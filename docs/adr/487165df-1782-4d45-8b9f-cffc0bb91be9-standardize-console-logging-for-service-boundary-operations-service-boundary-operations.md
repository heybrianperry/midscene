# Standardize Console Logging for Service Boundary Operations: Service Boundary Operations
...
1. MUST: All service boundary operations (chrome extension workers, recorder components, indexedDB operations, playground servers) MUST implement console logging for key lifecycle events

## Policy Block

- MUST All service boundary operations (chrome extension workers, recorder components, indexedDB operations, playground servers) MUST implement console logging for key lifecycle events
