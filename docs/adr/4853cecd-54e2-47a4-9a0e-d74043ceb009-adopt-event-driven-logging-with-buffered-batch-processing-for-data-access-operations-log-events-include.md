# Adopt Event-Driven Logging with Buffered Batch Processing for Data Access Operations: Log Events Include
...
1. MUST: Log events MUST include sufficient context (timestamps, operation type, correlation IDs) for distributed tracing and debugging

## Policy Block

- MUST Log events MUST include sufficient context (timestamps, operation type, correlation IDs) for distributed tracing and debugging
