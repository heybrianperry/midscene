# Standardize Core Library Module Imports and Dependencies: React Component Files
...
1. SHOULD: React component files SHOULD import React core libraries before third-party UI libraries and before internal component imports

## Policy Block

- SHOULD React component files SHOULD import React core libraries before third-party UI libraries and before internal component imports
