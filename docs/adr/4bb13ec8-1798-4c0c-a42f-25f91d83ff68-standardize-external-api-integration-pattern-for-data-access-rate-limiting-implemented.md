# Standardize External API Integration Pattern for Data Access: Rate Limiting Implemented
...
1. SHOULD: Rate limiting SHOULD be implemented client-side to respect API provider limits and prevent throttling

## Policy Block

- SHOULD Rate limiting SHOULD be implemented client-side to respect API provider limits and prevent throttling
