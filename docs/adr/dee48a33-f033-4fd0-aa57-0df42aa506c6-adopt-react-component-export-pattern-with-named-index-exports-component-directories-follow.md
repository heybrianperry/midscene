# Adopt React Component Export Pattern with Named Index Exports: Component Directories Follow
...
1. SHOULD: Component directories SHOULD follow the pattern: component-name/index.tsx as the public export and component-name/ComponentName.tsx as the implementation

## Policy Block

- SHOULD Component directories SHOULD follow the pattern: component-name/index.tsx as the public export and component-name/ComponentName.tsx as the implementation
