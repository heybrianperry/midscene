# Adopt Asynchronous Service Manager Pattern for UI Component Lifecycle: Service Managers Prevent
...
1. MUST: Service managers MUST prevent race conditions by ensuring dependent services are initialized in correct order

## Policy Block

- MUST Service managers MUST prevent race conditions by ensuring dependent services are initialized in correct order
