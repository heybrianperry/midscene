# Adopt Event-Driven Async Integration Pattern for Backend Communication: Event Driven Components
...
1. SHOULD: Event-driven components SHOULD provide typed event interfaces for type safety and developer experience

## Policy Block

- SHOULD Event-driven components SHOULD provide typed event interfaces for type safety and developer experience
