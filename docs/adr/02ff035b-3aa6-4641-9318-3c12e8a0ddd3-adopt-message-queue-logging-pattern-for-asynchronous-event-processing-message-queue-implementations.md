# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Message Queue Implementations
...
1. SHOULD: Message queue implementations SHOULD use structured logging formats (JSON) rather than unstructured text

## Policy Block

- SHOULD Message queue implementations SHOULD use structured logging formats (JSON) rather than unstructured text
