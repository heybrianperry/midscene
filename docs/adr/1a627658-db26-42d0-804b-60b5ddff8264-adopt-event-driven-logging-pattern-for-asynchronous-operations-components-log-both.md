# Adopt Event-Driven Logging Pattern for Asynchronous Operations: Components Log Both
...
1. SHOULD: Components SHOULD log both successful event processing and error conditions with appropriate severity levels

## Policy Block

- SHOULD Components SHOULD log both successful event processing and error conditions with appropriate severity levels
