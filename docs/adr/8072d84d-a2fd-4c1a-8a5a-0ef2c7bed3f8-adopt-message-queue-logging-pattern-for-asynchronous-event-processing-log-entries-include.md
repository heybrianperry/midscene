# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Log Entries Include
...
1. SHOULD: Log entries SHOULD include processing duration metrics for performance monitoring and bottleneck identification

## Policy Block

- SHOULD Log entries SHOULD include processing duration metrics for performance monitoring and bottleneck identification
