# Adopt Event-Driven Logging Pattern for Asynchronous Operations: Event Logs Include
...
1. MUST: Event logs MUST include contextual metadata such as event type, timestamp, and correlation identifiers to enable tracing across asynchronous boundaries

## Policy Block

- MUST Event logs MUST include contextual metadata such as event type, timestamp, and correlation identifiers to enable tracing across asynchronous boundaries
