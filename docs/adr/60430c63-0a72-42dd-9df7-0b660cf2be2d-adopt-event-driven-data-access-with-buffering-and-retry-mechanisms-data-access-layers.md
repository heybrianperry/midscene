# Adopt Event-Driven Data Access with Buffering and Retry Mechanisms: Data Access Layers
...
1. MUST: Data access layers MUST implement buffering mechanisms to handle bursts of events and prevent data loss during temporary processing delays

## Policy Block

- MUST Data access layers MUST implement buffering mechanisms to handle bursts of events and prevent data loss during temporary processing delays
