# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Message Queue Logs
...
1. SHOULD: Message queue logs SHOULD include correlation IDs to enable end-to-end tracing across architectural boundaries

## Policy Block

- SHOULD Message queue logs SHOULD include correlation IDs to enable end-to-end tracing across architectural boundaries
