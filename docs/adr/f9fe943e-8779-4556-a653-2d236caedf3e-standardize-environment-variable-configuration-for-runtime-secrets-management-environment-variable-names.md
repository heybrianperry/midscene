# Standardize Environment Variable Configuration for Runtime Secrets Management: Environment Variable Names
...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention with uppercase letters and underscores (e.g., API_KEY, SERVICE_URL, AUTH_TOKEN)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention with uppercase letters and underscores (e.g., API_KEY, SERVICE_URL, AUTH_TOKEN)
