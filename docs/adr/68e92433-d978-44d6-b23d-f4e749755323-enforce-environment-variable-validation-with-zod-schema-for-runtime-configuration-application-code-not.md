# Enforce Environment Variable Validation with Zod Schema for Runtime Configuration: Application Code Not
...
1. MUST_NOT: Application code MUST NOT directly access process.env or other unvalidated configuration sources; all access MUST go through validated configuration objects

## Policy Block

- MUST_NOT Application code MUST NOT directly access process.env or other unvalidated configuration sources; all access MUST go through validated configuration objects
