# Standardize External API Integration Pattern for Data Access: External Integrations Use
...
1. MUST: All external API integrations MUST use a centralized client wrapper that handles authentication, retries, and error normalization

## Policy Block

- MUST All external API integrations MUST use a centralized client wrapper that handles authentication, retries, and error normalization
