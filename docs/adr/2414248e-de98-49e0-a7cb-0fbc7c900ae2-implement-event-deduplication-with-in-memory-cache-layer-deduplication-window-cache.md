# Implement Event Deduplication with In-Memory Cache Layer: Deduplication Window Cache
...
1. SHOULD: The deduplication window (cache TTL) SHOULD be configured based on the expected duplicate arrival timeframe for the specific use case

## Policy Block

- SHOULD The deduplication window (cache TTL) SHOULD be configured based on the expected duplicate arrival timeframe for the specific use case
