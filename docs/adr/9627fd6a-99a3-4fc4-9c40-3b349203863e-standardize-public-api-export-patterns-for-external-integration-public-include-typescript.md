# Standardize Public API Export Patterns for External Integration: Public Include Typescript
...
1. MUST: Public APIs MUST include TypeScript type definitions or equivalent interface documentation for all exported functions, classes, and types

## Policy Block

- MUST Public APIs MUST include TypeScript type definitions or equivalent interface documentation for all exported functions, classes, and types
