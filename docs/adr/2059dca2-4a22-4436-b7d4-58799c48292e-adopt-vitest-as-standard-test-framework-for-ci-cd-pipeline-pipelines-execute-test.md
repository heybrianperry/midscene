# Adopt Vitest as Standard Test Framework for CI/CD Pipeline: Pipelines Execute Test
...
1. MUST: CI/CD pipelines MUST execute all test suites and fail builds on test failures

## Policy Block

- MUST CI/CD pipelines MUST execute all test suites and fail builds on test failures
