# Standardize Middleware-Based Logging for Request/Response Lifecycle: Error Conditions Encountered
...
1. SHOULD: Error conditions encountered in middleware SHOULD be logged with ERROR level severity and include stack traces, error codes, and contextual information for debugging

## Policy Block

- SHOULD Error conditions encountered in middleware SHOULD be logged with ERROR level severity and include stack traces, error codes, and contextual information for debugging
