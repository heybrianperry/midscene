# Standardize External API Integration Pattern for Data Access: External Integrations Implement
...
1. SHOULD: External API integrations SHOULD implement exponential backoff retry logic for transient failures (5xx errors, network timeouts)

## Policy Block

- SHOULD External API integrations SHOULD implement exponential backoff retry logic for transient failures (5xx errors, network timeouts)
