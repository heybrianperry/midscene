# Adopt Client-Side Cache Layer for Public API State Management: Sensitive Authentication Tokens
...
1. MUST_NOT: Sensitive authentication tokens or personally identifiable information MUST NOT be stored in client-side caches without encryption

## Policy Block

- MUST_NOT Sensitive authentication tokens or personally identifiable information MUST NOT be stored in client-side caches without encryption
