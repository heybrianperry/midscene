# Adopt Asynchronous Service Manager Pattern for UI Component Lifecycle: Service Managers Handle
...
1. MUST: Service managers MUST handle Promise-based lifecycle operations (start, stop, cleanup) to ensure proper async/await patterns

## Policy Block

- MUST Service managers MUST handle Promise-based lifecycle operations (start, stop, cleanup) to ensure proper async/await patterns
