# Adopt Service Client Integration Pattern for Backend Communication: Build Packaging Scripts
...
1. MUST: Build and packaging scripts MUST use consistent integration patterns when coordinating with backend services

## Policy Block

- MUST Build and packaging scripts MUST use consistent integration patterns when coordinating with backend services
