# Adopt Client-Side Cache Layer for Public API State Management: Cache Layers Implement
...
1. MAY: Cache layers MAY implement background synchronization to refresh stale data proactively

## Policy Block

- MAY Cache layers MAY implement background synchronization to refresh stale data proactively
