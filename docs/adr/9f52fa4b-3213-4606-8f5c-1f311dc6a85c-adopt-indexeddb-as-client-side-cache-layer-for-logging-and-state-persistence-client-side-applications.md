# Adopt IndexedDB as Client-Side Cache Layer for Logging and State Persistence: Client Side Applications
...
1. MUST: Client-side applications MUST use IndexedDB as the primary cache layer for persistent logging and state management

## Policy Block

- MUST Client-side applications MUST use IndexedDB as the primary cache layer for persistent logging and state management
