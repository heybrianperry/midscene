# Adopt Event-Driven Logging with Buffered Batch Processing for Data Access Operations: Data Access Operations
...
1. MUST: Data access operations MUST emit structured log events that can be captured by an event-driven logging system

## Policy Block

- MUST Data access operations MUST emit structured log events that can be captured by an event-driven logging system
