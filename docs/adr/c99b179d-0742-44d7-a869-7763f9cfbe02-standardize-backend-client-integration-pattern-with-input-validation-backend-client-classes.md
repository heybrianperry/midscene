# Standardize Backend Client Integration Pattern with Input Validation: Backend Client Classes
...
1. MUST: All backend client classes MUST be unit tested with mock external services to verify validation and error handling

## Policy Block

- MUST All backend client classes MUST be unit tested with mock external services to verify validation and error handling
