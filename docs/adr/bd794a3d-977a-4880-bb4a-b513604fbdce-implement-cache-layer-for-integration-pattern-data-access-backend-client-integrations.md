# Implement Cache Layer for Integration Pattern Data Access: Backend Client Integrations
...
1. SHOULD: Backend client integrations SHOULD implement stale-while-revalidate patterns to serve cached data while asynchronously refreshing

## Policy Block

- SHOULD Backend client integrations SHOULD implement stale-while-revalidate patterns to serve cached data while asynchronously refreshing
