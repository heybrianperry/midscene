# Standardize Test File Naming with .test.ts Extension for TypeScript Tests: Test Files Not
...
1. MUST_NOT: Test files MUST NOT use alternative extensions such as .spec.ts, .test.tsx, or _test.ts unless explicitly documented as exceptions

## Policy Block

- MUST_NOT Test files MUST NOT use alternative extensions such as .spec.ts, .test.tsx, or _test.ts unless explicitly documented as exceptions
