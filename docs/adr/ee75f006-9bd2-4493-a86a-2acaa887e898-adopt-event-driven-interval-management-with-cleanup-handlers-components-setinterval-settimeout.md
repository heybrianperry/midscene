# Adopt Event-Driven Interval Management with Cleanup Handlers: Components Setinterval Settimeout
...
1. MUST: Components using setInterval or setTimeout for data access MUST store interval/timeout IDs and provide a mechanism to cancel them

## Policy Block

- MUST Components using setInterval or setTimeout for data access MUST store interval/timeout IDs and provide a mechanism to cancel them
