# Standardize Test File Naming with .test.ts Extension for TypeScript Tests: Test File Names
...
1. SHOULD: Test file names SHOULD clearly indicate the module or functionality under test (e.g., event-memory-stress.test.ts for event memory stress testing)

## Policy Block

- SHOULD Test file names SHOULD clearly indicate the module or functionality under test (e.g., event-memory-stress.test.ts for event memory stress testing)
