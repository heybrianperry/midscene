# Implement Cache Layer for Integration Pattern Data Access: Cache Keys Deterministic
...
1. MUST: Cache keys MUST be deterministic and uniquely identify the cached resource to prevent cache collisions

## Policy Block

- MUST Cache keys MUST be deterministic and uniquely identify the cached resource to prevent cache collisions
