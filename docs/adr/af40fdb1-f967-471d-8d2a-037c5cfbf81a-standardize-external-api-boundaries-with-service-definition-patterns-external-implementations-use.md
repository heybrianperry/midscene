# Standardize External API Boundaries with Service Definition Patterns: External Implementations Use
...
1. MUST: External API implementations MUST use provider patterns or similar abstractions to enable multiple implementations behind a stable interface

## Policy Block

- MUST External API implementations MUST use provider patterns or similar abstractions to enable multiple implementations behind a stable interface
