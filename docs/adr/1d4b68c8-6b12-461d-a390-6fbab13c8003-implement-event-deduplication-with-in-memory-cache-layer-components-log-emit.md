# Implement Event Deduplication with In-Memory Cache Layer: Components Log Emit
...
1. SHOULD: Components SHOULD log or emit metrics when duplicate events are detected and filtered

## Policy Block

- SHOULD Components SHOULD log or emit metrics when duplicate events are detected and filtered
