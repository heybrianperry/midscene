# Adopt Service Client Integration Pattern for Backend Communication: Client Implementations Provide
...
1. MAY: Client implementations MAY provide retry logic and error handling strategies appropriate to their execution context

## Policy Block

- MAY Client implementations MAY provide retry logic and error handling strategies appropriate to their execution context
