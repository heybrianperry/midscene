# Adopt Playwright for Browser-Based Testing and Rendering Verification: Browser Based Rendering
...
1. MUST: All browser-based UI rendering tests MUST use Playwright as the primary testing framework

## Policy Block

- MUST All browser-based UI rendering tests MUST use Playwright as the primary testing framework
