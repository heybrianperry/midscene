# Enforce Environment Variable Validation with Zod Schema for Runtime Configuration: Environment Variables External
...
1. MUST: All environment variables and external configuration MUST be validated using Zod schemas before use in application logic

## Policy Block

- MUST All environment variables and external configuration MUST be validated using Zod schemas before use in application logic
