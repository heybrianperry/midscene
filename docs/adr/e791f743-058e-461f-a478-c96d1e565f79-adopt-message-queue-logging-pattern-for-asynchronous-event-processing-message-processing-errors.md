# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Message Processing Errors
...
1. MUST: Message processing errors MUST be logged with full error context including message payload, error type, and stack trace

## Policy Block

- MUST Message processing errors MUST be logged with full error context including message payload, error type, and stack trace
