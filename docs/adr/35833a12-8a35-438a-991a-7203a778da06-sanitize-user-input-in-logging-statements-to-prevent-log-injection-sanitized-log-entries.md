# Sanitize User Input in Logging Statements to Prevent Log Injection: Sanitized Log Entries
...
1. SHOULD: Sanitized log entries SHOULD preserve sufficient information for debugging while removing security risks

## Policy Block

- SHOULD Sanitized log entries SHOULD preserve sufficient information for debugging while removing security risks
