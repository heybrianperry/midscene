# Adopt Message-Based Communication for Chrome Extension Component Integration: Communication Between Chrome
...
1. MUST: All communication between Chrome extension contexts (background, content script, popup, injected page) MUST use message-based communication via chrome.runtime.sendMessage or chrome.tabs.sendMessage APIs

## Policy Block

- MUST All communication between Chrome extension contexts (background, content script, popup, injected page) MUST use message-based communication via chrome.runtime.sendMessage or chrome.tabs.sendMessage APIs
