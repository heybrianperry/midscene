# Adopt Asynchronous Service Manager Pattern for UI Component Lifecycle: Components That Manage
...
1. MUST: UI components that manage multiple services MUST use a dedicated ServiceManager or equivalent abstraction to coordinate asynchronous initialization

## Policy Block

- MUST UI components that manage multiple services MUST use a dedicated ServiceManager or equivalent abstraction to coordinate asynchronous initialization
