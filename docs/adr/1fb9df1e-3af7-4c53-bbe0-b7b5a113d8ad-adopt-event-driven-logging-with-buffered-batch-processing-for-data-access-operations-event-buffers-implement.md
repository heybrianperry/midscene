# Adopt Event-Driven Logging with Buffered Batch Processing for Data Access Operations: Event Buffers Implement
...
1. SHOULD: Event buffers SHOULD implement configurable flush intervals and size thresholds to balance latency and throughput

## Policy Block

- SHOULD Event buffers SHOULD implement configurable flush intervals and size thresholds to balance latency and throughput
