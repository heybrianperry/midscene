# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Components Implement Sampling
...
1. MAY: Components MAY implement sampling strategies for high-volume message queues to reduce log overhead while maintaining observability

## Policy Block

- MAY Components MAY implement sampling strategies for high-volume message queues to reduce log overhead while maintaining observability
