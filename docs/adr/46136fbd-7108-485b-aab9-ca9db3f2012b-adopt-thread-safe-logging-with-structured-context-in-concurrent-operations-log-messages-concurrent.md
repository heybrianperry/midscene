# Adopt Thread-Safe Logging with Structured Context in Concurrent Operations: Log Messages Concurrent
...
1. SHOULD: Log messages from concurrent operations SHOULD include timestamps with sufficient precision (millisecond or better) to enable temporal ordering of events

## Policy Block

- SHOULD Log messages from concurrent operations SHOULD include timestamps with sufficient precision (millisecond or better) to enable temporal ordering of events
