# Standardize Environment Variable Configuration for Runtime Secrets Management: Environment Variable Access
...
1. SHOULD: Environment variable access SHOULD be centralized in configuration modules rather than scattered throughout application code

## Policy Block

- SHOULD Environment variable access SHOULD be centralized in configuration modules rather than scattered throughout application code
