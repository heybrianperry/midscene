# Adopt Event-Driven Polling with Interval-Based State Synchronization: Polling Intervals Stored
...
1. MUST: Polling intervals MUST be stored as constants or configuration values rather than hardcoded magic numbers

## Policy Block

- MUST Polling intervals MUST be stored as constants or configuration values rather than hardcoded magic numbers
