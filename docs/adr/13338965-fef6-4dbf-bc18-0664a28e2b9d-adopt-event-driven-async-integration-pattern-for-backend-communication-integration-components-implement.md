# Adopt Event-Driven Async Integration Pattern for Backend Communication: Integration Components Implement
...
1. MUST: Integration components MUST implement event-driven architectures using EventEmitter or equivalent patterns for state changes and notifications

## Policy Block

- MUST Integration components MUST implement event-driven architectures using EventEmitter or equivalent patterns for state changes and notifications
