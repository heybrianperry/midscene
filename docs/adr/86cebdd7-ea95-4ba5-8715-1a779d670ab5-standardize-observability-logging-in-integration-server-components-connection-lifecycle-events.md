# Standardize Observability Logging in Integration Server Components: Connection Lifecycle Events
...
1. MUST: Connection lifecycle events (connect, disconnect, error) MUST be logged with client identifiers and timestamps

## Policy Block

- MUST Connection lifecycle events (connect, disconnect, error) MUST be logged with client identifiers and timestamps
