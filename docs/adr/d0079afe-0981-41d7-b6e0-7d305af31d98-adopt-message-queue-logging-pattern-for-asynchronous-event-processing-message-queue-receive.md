# Adopt Message Queue Logging Pattern for Asynchronous Event Processing: Message Queue Receive
...
1. MUST: All message queue receive operations MUST log the message type, source, and timestamp upon receipt

## Policy Block

- MUST All message queue receive operations MUST log the message type, source, and timestamp upon receipt
