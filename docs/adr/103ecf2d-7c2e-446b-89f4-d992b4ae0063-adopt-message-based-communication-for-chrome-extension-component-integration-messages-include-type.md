# Adopt Message-Based Communication for Chrome Extension Component Integration: Messages Include Type
...
1. MUST: All messages MUST include a 'type' or 'action' field to enable message routing and handler dispatch

## Policy Block

- MUST All messages MUST include a 'type' or 'action' field to enable message routing and handler dispatch
