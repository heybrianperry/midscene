# Sanitize User Input in Logging Statements to Prevent Log Injection: Ansi Escape Sequences
...
1. MUST: ANSI escape sequences and control characters MUST be stripped or escaped from user input before logging

## Policy Block

- MUST ANSI escape sequences and control characters MUST be stripped or escaped from user input before logging
