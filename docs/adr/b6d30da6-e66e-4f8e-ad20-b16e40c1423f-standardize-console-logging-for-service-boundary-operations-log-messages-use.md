# Standardize Console Logging for Service Boundary Operations: Log Messages Use
...
1. SHOULD: Log messages SHOULD use appropriate console methods (console.log for info, console.error for errors, console.warn for warnings) to indicate severity

## Policy Block

- SHOULD Log messages SHOULD use appropriate console methods (console.log for info, console.error for errors, console.warn for warnings) to indicate severity
