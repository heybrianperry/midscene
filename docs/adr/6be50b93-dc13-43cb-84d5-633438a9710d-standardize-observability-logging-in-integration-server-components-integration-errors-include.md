# Standardize Observability Logging in Integration Server Components: Integration Errors Include
...
1. SHOULD: Integration errors SHOULD include contextual metadata such as request payloads, headers, and stack traces (with sensitive data redacted)

## Policy Block

- SHOULD Integration errors SHOULD include contextual metadata such as request payloads, headers, and stack traces (with sensitive data redacted)
