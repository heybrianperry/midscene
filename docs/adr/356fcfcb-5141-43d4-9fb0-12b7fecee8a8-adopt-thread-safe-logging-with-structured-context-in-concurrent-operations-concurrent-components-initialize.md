# Adopt Thread-Safe Logging with Structured Context in Concurrent Operations: Concurrent Components Initialize
...
1. SHOULD: Concurrent components SHOULD initialize logging context at component creation time and propagate context through the execution lifecycle

## Policy Block

- SHOULD Concurrent components SHOULD initialize logging context at component creation time and propagate context through the execution lifecycle
