# Enforce Environment Variable Validation with Zod Schema for Runtime Configuration: Configuration Schemas Use
...
1. SHOULD: Configuration schemas SHOULD use Zod's transformation capabilities (e.g., z.coerce) to handle type conversion from string environment variables

## Policy Block

- SHOULD Configuration schemas SHOULD use Zod's transformation capabilities (e.g., z.coerce) to handle type conversion from string environment variables
