# Adopt Event-Driven Process Lifecycle Management for External Services: Process Lifecycle Events
...
1. SHOULD: Process lifecycle events SHOULD be observable through callbacks, promises, or event emitters to enable reactive integration patterns

## Policy Block

- SHOULD Process lifecycle events SHOULD be observable through callbacks, promises, or event emitters to enable reactive integration patterns
