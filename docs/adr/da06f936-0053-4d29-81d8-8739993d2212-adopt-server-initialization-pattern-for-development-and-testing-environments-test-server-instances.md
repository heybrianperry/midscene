# Adopt Server Initialization Pattern for Development and Testing Environments: Test Server Instances
...
1. SHOULD: Test server instances SHOULD use dynamic port allocation (port 0) to avoid conflicts in parallel test execution

## Policy Block

- SHOULD Test server instances SHOULD use dynamic port allocation (port 0) to avoid conflicts in parallel test execution
