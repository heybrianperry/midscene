# Standardize Environment Variable Configuration Management Pattern: Environment Variable Access
...
1. MUST: All environment variable access MUST be centralized in dedicated configuration modules or files (e.g., common.ts, config.ts, env.ts)

## Policy Block

- MUST All environment variable access MUST be centralized in dedicated configuration modules or files (e.g., common.ts, config.ts, env.ts)
