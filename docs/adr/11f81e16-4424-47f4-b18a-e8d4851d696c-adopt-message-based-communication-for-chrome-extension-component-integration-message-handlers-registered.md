# Adopt Message-Based Communication for Chrome Extension Component Integration: Message Handlers Registered
...
1. MUST: Message handlers MUST be registered using chrome.runtime.onMessage.addListener with proper sender validation

## Policy Block

- MUST Message handlers MUST be registered using chrome.runtime.onMessage.addListener with proper sender validation
