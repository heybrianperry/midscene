# Adopt IndexedDB as Client-Side Cache Layer for Logging and State Persistence: Cache Implementations Implement
...
1. SHOULD: Cache implementations SHOULD implement automatic cleanup policies (TTL, size limits) to prevent unbounded storage growth

## Policy Block

- SHOULD Cache implementations SHOULD implement automatic cleanup policies (TTL, size limits) to prevent unbounded storage growth
