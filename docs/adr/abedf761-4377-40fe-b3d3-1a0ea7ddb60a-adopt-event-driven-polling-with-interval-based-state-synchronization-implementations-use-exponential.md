# Adopt Event-Driven Polling with Interval-Based State Synchronization: Implementations Use Exponential
...
1. MAY: Implementations MAY use exponential backoff or adaptive intervals when connection failures or errors are detected

## Policy Block

- MAY Implementations MAY use exponential backoff or adaptive intervals when connection failures or errors are detected
