# Adopt Process Lifecycle Management Pattern for External Service Integration: Process Spawning Include
...
1. MUST: Process spawning MUST include health check mechanisms to verify service readiness before proceeding with dependent operations

## Policy Block

- MUST Process spawning MUST include health check mechanisms to verify service readiness before proceeding with dependent operations
