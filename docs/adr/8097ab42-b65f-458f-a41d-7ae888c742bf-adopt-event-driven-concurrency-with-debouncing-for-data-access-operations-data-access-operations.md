# Adopt Event-Driven Concurrency with Debouncing for Data Access Operations: Data Access Operations
...
1. MUST: Data access operations triggered by high-frequency events MUST implement debouncing or throttling mechanisms to prevent excessive API calls

## Policy Block

- MUST Data access operations triggered by high-frequency events MUST implement debouncing or throttling mechanisms to prevent excessive API calls
