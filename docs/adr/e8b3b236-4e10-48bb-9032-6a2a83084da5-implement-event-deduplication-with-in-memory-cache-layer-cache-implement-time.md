# Implement Event Deduplication with In-Memory Cache Layer: Cache Implement Time
...
1. MUST: The cache MUST implement a time-based or size-based eviction policy to prevent unbounded memory growth

## Policy Block

- MUST The cache MUST implement a time-based or size-based eviction policy to prevent unbounded memory growth
