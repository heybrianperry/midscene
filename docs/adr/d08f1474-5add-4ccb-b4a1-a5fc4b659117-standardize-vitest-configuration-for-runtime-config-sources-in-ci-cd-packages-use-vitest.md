# Standardize Vitest Configuration for Runtime Config Sources in CI/CD: Packages Use Vitest
...
1. MUST: All packages MUST use Vitest as the standard test framework with centralized configuration files

## Policy Block

- MUST All packages MUST use Vitest as the standard test framework with centralized configuration files
