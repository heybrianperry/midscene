# Adopt WebSocket-Based Real-Time Integration for Backend Communication: Real Time Integration
...
1. MUST: Real-time integration components MUST use WebSocket protocol for bidirectional communication with backend services when latency-sensitive operations are required

## Policy Block

- MUST Real-time integration components MUST use WebSocket protocol for bidirectional communication with backend services when latency-sensitive operations are required
