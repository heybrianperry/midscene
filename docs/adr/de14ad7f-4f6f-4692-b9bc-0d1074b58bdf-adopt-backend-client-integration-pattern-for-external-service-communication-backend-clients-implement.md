# Adopt Backend Client Integration Pattern for External Service Communication: Backend Clients Implement
...
1. MUST: Backend clients MUST implement consistent error handling patterns including connection failures, timeouts, and service unavailability scenarios

## Policy Block

- MUST Backend clients MUST implement consistent error handling patterns including connection failures, timeouts, and service unavailability scenarios
