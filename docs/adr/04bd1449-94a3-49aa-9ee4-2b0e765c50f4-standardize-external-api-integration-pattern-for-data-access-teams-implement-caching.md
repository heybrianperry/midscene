# Standardize External API Integration Pattern for Data Access: Teams Implement Caching
...
1. MAY: Teams MAY implement caching layers for external API responses when data freshness requirements allow

## Policy Block

- MAY Teams MAY implement caching layers for external API responses when data freshness requirements allow
