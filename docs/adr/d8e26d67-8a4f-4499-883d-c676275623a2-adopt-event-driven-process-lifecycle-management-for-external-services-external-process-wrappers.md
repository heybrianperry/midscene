# Adopt Event-Driven Process Lifecycle Management for External Services: External Process Wrappers
...
1. MUST: All external process wrappers MUST implement graceful shutdown with proper cleanup of resources (ports, file handles, child processes)

## Policy Block

- MUST All external process wrappers MUST implement graceful shutdown with proper cleanup of resources (ports, file handles, child processes)
