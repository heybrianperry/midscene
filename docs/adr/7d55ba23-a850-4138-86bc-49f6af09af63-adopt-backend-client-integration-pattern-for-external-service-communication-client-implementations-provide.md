# Adopt Backend Client Integration Pattern for External Service Communication: Client Implementations Provide
...
1. MUST: Client implementations MUST provide typed interfaces or contracts that define the available operations and expected responses

## Policy Block

- MUST Client implementations MUST provide typed interfaces or contracts that define the available operations and expected responses
