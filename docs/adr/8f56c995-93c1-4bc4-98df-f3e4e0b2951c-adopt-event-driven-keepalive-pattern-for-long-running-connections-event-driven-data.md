# Adopt Event-Driven Keepalive Pattern for Long-Running Connections: Event Driven Data
...
1. MUST: Event-driven data access patterns MUST include event optimization to prevent excessive resource consumption

## Policy Block

- MUST Event-driven data access patterns MUST include event optimization to prevent excessive resource consumption
