# Standardize Observability Logging in Integration Server Components: Server Startup Shutdown
...
1. MUST: Server startup and shutdown events MUST be logged with severity level INFO, including port numbers, bind addresses, and configuration parameters

## Policy Block

- MUST Server startup and shutdown events MUST be logged with severity level INFO, including port numbers, bind addresses, and configuration parameters
