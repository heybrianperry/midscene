# Adopt React Component Export Pattern with Named Index Exports: Internal Helper Components
...
1. SHOULD: Internal helper components or utilities within a component directory SHOULD NOT be re-exported through the index.tsx unless explicitly part of the public API

## Policy Block

- SHOULD Internal helper components or utilities within a component directory SHOULD NOT be re-exported through the index.tsx unless explicitly part of the public API
