# Adopt React Component Export Pattern with Named Index Exports: Component Index Files
...
1. MAY: Component index files MAY re-export types, interfaces, and props definitions that are part of the component's public contract

## Policy Block

- MAY Component index files MAY re-export types, interfaces, and props definitions that are part of the component's public contract
