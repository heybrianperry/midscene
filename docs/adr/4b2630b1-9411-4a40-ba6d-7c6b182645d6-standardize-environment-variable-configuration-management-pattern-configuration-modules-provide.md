...
1. SHOULD: Configuration modules SHOULD provide default values for non-critical environment variables

## Policy Block

- SHOULD Configuration modules SHOULD provide default values for non-critical environment variables
