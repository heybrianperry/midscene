# Adopt Process Lifecycle Management Pattern for External Service Integration: Process Lifecycle Events
...
1. SHOULD: Process lifecycle events SHOULD be logged with sufficient detail to support debugging and operational monitoring

## Policy Block

- SHOULD Process lifecycle events SHOULD be logged with sufficient detail to support debugging and operational monitoring
