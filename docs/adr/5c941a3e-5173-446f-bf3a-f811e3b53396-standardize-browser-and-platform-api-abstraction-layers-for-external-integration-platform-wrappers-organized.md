# Standardize Browser and Platform API Abstraction Layers for External Integration: Platform Wrappers Organized
...
1. SHOULD: Platform API wrappers SHOULD be organized by functional domain (e.g., chrome.ts for Chrome APIs, printer.ts for output APIs) rather than by technical layer

## Policy Block

- SHOULD Platform API wrappers SHOULD be organized by functional domain (e.g., chrome.ts for Chrome APIs, printer.ts for output APIs) rather than by technical layer
