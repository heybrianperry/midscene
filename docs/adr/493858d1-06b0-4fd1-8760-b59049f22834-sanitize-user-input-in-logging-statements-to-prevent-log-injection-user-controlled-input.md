# Sanitize User Input in Logging Statements to Prevent Log Injection: User Controlled Input
...
1. MUST: All user-controlled input and external data MUST be sanitized before being written to logs

## Policy Block

- MUST All user-controlled input and external data MUST be sanitized before being written to logs
