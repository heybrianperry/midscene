# Standardize External API Integration Pattern for Data Access: Responses Validated Against
...
1. MUST: API responses MUST be validated against expected schemas before being passed to consuming code

## Policy Block

- MUST API responses MUST be validated against expected schemas before being passed to consuming code
