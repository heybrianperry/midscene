# Adopt Event-Driven Keepalive Pattern for Long-Running Connections: Keepalive Implementations Use
...
1. SHOULD: Keepalive implementations SHOULD use configurable intervals to adapt to different network conditions and application requirements

## Policy Block

- SHOULD Keepalive implementations SHOULD use configurable intervals to adapt to different network conditions and application requirements
