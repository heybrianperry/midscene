# Adopt Event-Driven Process Lifecycle Management for External Services: External Service Integrations
...
1. SHOULD: External service integrations SHOULD capture and expose process output (stdout/stderr) for debugging and monitoring

## Policy Block

- SHOULD External service integrations SHOULD capture and expose process output (stdout/stderr) for debugging and monitoring
