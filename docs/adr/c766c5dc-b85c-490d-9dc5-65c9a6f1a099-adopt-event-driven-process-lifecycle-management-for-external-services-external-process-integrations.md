# Adopt Event-Driven Process Lifecycle Management for External Services: External Process Integrations
...
1. MUST: External process integrations MUST implement event-driven lifecycle management with explicit startup, ready, and shutdown phases

## Policy Block

- MUST External process integrations MUST implement event-driven lifecycle management with explicit startup, ready, and shutdown phases
