# Standardize Backend Client Integration Pattern with Input Validation: Integration Points Sanitize
...
1. MUST: Integration points MUST sanitize and validate data received from external services before processing

## Policy Block

- MUST Integration points MUST sanitize and validate data received from external services before processing
