# Standardize External API Boundaries with Service Definition Patterns: External Defined Through
...
1. MUST: All external APIs MUST be defined through explicit service definition interfaces that declare the contract between the system and external consumers

## Policy Block

- MUST All external APIs MUST be defined through explicit service definition interfaces that declare the contract between the system and external consumers
