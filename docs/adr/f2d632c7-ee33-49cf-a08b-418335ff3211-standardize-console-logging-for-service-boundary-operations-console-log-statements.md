# Standardize Console Logging for Service Boundary Operations: Console Log Statements
...
1. MUST: Console log statements MUST include sufficient context to identify the service component, operation type, and relevant identifiers

## Policy Block

- MUST Console log statements MUST include sufficient context to identify the service component, operation type, and relevant identifiers
