# Adopt Backend Client Integration Pattern for External Service Communication: Backend Client Logic
...
1. MUST_NOT: Backend client logic MUST NOT be directly embedded in business logic or UI components without proper abstraction

## Policy Block

- MUST_NOT Backend client logic MUST NOT be directly embedded in business logic or UI components without proper abstraction
