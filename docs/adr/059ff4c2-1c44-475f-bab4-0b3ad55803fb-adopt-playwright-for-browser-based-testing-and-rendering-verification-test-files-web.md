# Adopt Playwright for Browser-Based Testing and Rendering Verification: Test Files Web
...
1. MUST: Test files for web integration MUST be placed in appropriate test directories with clear naming conventions (e.g., *.spec.ts for Playwright tests)

## Policy Block

- MUST Test files for web integration MUST be placed in appropriate test directories with clear naming conventions (e.g., *.spec.ts for Playwright tests)
