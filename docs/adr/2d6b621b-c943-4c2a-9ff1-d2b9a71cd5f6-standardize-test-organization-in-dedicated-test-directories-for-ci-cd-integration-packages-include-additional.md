# Standardize Test Organization in Dedicated Test Directories for CI/CD Integration: Packages Include Additional
...
1. MAY: Packages MAY include additional test categories beyond unit/integration (e.g., stress tests, performance tests) in appropriately named subdirectories

## Policy Block

- MAY Packages MAY include additional test categories beyond unit/integration (e.g., stress tests, performance tests) in appropriately named subdirectories
