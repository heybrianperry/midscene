# Standardize Middleware-Based Logging for Request/Response Lifecycle: Middleware Logging Not
...
1. MUST_NOT: Middleware logging MUST NOT log sensitive data such as passwords, tokens, or personally identifiable information (PII) without explicit redaction

## Policy Block

- MUST_NOT Middleware logging MUST NOT log sensitive data such as passwords, tokens, or personally identifiable information (PII) without explicit redaction
