# Standardize Environment Variable Configuration Management Pattern: Environment Variable Validation
...
1. MUST: Environment variable validation MUST occur at application initialization time, not at point of use

## Policy Block

- MUST Environment variable validation MUST occur at application initialization time, not at point of use
