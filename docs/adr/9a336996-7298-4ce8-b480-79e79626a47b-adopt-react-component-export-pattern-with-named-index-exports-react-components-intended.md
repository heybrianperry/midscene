# Adopt React Component Export Pattern with Named Index Exports: React Components Intended
...
1. MUST: All React components intended for external consumption MUST be exported through an index.tsx file in their component directory

## Policy Block

- MUST All React components intended for external consumption MUST be exported through an index.tsx file in their component directory
