# Adopt Event-Driven Data Access with Buffering and Retry Mechanisms: Data Access Implementations
...
1. MUST: Data access implementations MUST handle connection lifecycle events (connect, disconnect, reconnect) explicitly

## Policy Block

- MUST Data access implementations MUST handle connection lifecycle events (connect, disconnect, reconnect) explicitly
