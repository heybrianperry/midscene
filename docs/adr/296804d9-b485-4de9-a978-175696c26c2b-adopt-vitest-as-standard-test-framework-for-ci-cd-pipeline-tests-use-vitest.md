# Adopt Vitest as Standard Test Framework for CI/CD Pipeline: Tests Use Vitest
...
1. MAY: Tests MAY use Vitest's concurrent execution features to improve test suite performance

## Policy Block

- MAY Tests MAY use Vitest's concurrent execution features to improve test suite performance
