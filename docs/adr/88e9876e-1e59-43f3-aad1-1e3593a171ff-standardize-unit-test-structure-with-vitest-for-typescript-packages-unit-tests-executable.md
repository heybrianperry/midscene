# Standardize Unit Test Structure with Vitest for TypeScript Packages: Unit Tests Executable
...
1. MUST: Unit tests MUST be executable via npm/yarn test commands in CI/CD pipelines

## Policy Block

- MUST Unit tests MUST be executable via npm/yarn test commands in CI/CD pipelines
