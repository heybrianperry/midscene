# Sanitize User Input in Logging Statements to Prevent Log Injection: Log Sanitization Remove
...
1. MUST: Log sanitization MUST remove or escape newline characters (\n, \r), carriage returns, and line terminators to prevent log injection

## Policy Block

- MUST Log sanitization MUST remove or escape newline characters (\n, \r), carriage returns, and line terminators to prevent log injection
