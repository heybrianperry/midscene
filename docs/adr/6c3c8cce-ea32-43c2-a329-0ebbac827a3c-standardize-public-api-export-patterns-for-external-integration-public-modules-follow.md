# Standardize Public API Export Patterns for External Integration: Public Modules Follow
...
1. SHOULD: Public API modules SHOULD follow a consistent naming convention (e.g., index.ts, public-api.ts, or exports.ts) across all packages

## Policy Block

- SHOULD Public API modules SHOULD follow a consistent naming convention (e.g., index.ts, public-api.ts, or exports.ts) across all packages
