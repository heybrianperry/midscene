# Adopt Environment-Driven Configuration Management for Chrome Extension Packaging and Device Control: Chrome Extension Packaging
...
1. MUST: Chrome extension packaging scripts MUST support environment-specific manifest modifications, asset bundling, and output paths based on detected or specified environment

## Policy Block

- MUST Chrome extension packaging scripts MUST support environment-specific manifest modifications, asset bundling, and output paths based on detected or specified environment
