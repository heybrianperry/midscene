# Adopt Event-Driven Keepalive Pattern for Long-Running Connections: Connection Management Utilities
...
1. MUST: Connection management utilities MUST handle browser lifecycle events (suspend, resume, visibility changes) appropriately

## Policy Block

- MUST Connection management utilities MUST handle browser lifecycle events (suspend, resume, visibility changes) appropriately
