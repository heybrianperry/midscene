# Adopt Event-Driven Async Integration Pattern for Backend Communication: Integration Components Use
...
1. MAY: Integration components MAY use Promise-based or Observable-based patterns depending on use case requirements

## Policy Block

- MAY Integration components MAY use Promise-based or Observable-based patterns depending on use case requirements
