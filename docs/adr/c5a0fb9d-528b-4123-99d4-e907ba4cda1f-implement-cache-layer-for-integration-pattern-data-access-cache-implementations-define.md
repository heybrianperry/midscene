# Implement Cache Layer for Integration Pattern Data Access: Cache Implementations Define
...
1. MUST: Cache implementations MUST define explicit TTL (time-to-live) or invalidation strategies appropriate to the data freshness requirements

## Policy Block

- MUST Cache implementations MUST define explicit TTL (time-to-live) or invalidation strategies appropriate to the data freshness requirements
