# Adopt Client-Side Cache Layer for Public API State Management: Cache Implementations Provide
...
1. SHOULD: Cache implementations SHOULD provide fallback mechanisms when storage quota is exceeded or unavailable

## Policy Block

- SHOULD Cache implementations SHOULD provide fallback mechanisms when storage quota is exceeded or unavailable
