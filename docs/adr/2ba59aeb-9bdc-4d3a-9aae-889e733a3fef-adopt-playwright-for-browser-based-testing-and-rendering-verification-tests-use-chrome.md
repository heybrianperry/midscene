# Adopt Playwright for Browser-Based Testing and Rendering Verification: Tests Use Chrome
...
1. MAY: Tests MAY use Chrome DevTools Protocol (CDP) directly for advanced browser automation scenarios not covered by standard Playwright APIs

## Policy Block

- MAY Tests MAY use Chrome DevTools Protocol (CDP) directly for advanced browser automation scenarios not covered by standard Playwright APIs
