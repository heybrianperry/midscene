# Adopt Client-Side Cache Layer for Public API State Management: Cache Providers Use
...
1. SHOULD: Cache providers SHOULD use IndexedDB for structured data exceeding 5MB or requiring complex queries

## Policy Block

- SHOULD Cache providers SHOULD use IndexedDB for structured data exceeding 5MB or requiring complex queries
