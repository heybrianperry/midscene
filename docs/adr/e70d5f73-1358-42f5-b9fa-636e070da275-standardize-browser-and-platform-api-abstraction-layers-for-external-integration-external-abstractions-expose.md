# Standardize Browser and Platform API Abstraction Layers for External Integration: External Abstractions Expose
...
1. SHOULD: External API abstractions SHOULD expose promise-based or async interfaces even when wrapping callback-based platform APIs

## Policy Block

- SHOULD External API abstractions SHOULD expose promise-based or async interfaces even when wrapping callback-based platform APIs
