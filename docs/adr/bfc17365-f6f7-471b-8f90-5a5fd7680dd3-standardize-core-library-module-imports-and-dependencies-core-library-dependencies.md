# Standardize Core Library Module Imports and Dependencies: Core Library Dependencies
...
1. MUST: Core library dependencies MUST be explicitly declared in the appropriate package manifest (package.json for TypeScript/JavaScript, CMakeLists.txt or similar for C++)

## Policy Block

- MUST Core library dependencies MUST be explicitly declared in the appropriate package manifest (package.json for TypeScript/JavaScript, CMakeLists.txt or similar for C++)
