# Standardize Public API Export Patterns for External Integration: Internal Implementation Details
...
1. MUST_NOT: Internal implementation details MUST NOT be exposed through public API surfaces without explicit documentation marking them as unstable

## Policy Block

- MUST_NOT Internal implementation details MUST NOT be exposed through public API surfaces without explicit documentation marking them as unstable
