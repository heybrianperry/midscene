# Standardize Test File Naming with .test.ts Extension for TypeScript Tests: Test Files Organized
...
1. MAY: Test files MAY be organized in dedicated test directories (e.g., tests/, __tests__/) or co-located with source files based on package conventions

## Policy Block

- MAY Test files MAY be organized in dedicated test directories (e.g., tests/, __tests__/) or co-located with source files based on package conventions
