# Standardize External API Boundaries with Service Definition Patterns: Service Definitions Include
...
1. MAY: Service definitions MAY include multiple provider implementations (e.g., IndexedDB, localStorage, remote) as long as they conform to the same interface contract

## Policy Block

- MAY Service definitions MAY include multiple provider implementations (e.g., IndexedDB, localStorage, remote) as long as they conform to the same interface contract
